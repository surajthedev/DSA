...
class Solution:
    def lexicographicallySmallestArray(self, nums, limit):
        ...
        for i in range(n):
            ...
            # Get values belonging to this component
            values = [nums[idx] for idx in component_indices]
            ...
            for idx, value in zip(component_indices, values):
                ans[idx] = value
...
class Solution:
    def lexicographicallySmallestArray(self, nums, limit):
        ...
        while left < n:
            ...
            # Original indices of this component
